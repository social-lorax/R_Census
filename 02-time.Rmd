...
If crosswalks between older vintages are needed, the [Longitudinal Tract Data Base at Brown University](https://s4.ad.brown.edu/projects/diversity/Researcher/LTBDDload/DataList.aspx) provides crosswalks for comparing tracts from 1970-2020. These crosswalks are less detailed as they only convert Census tract geographies to the 2010 boundaries and only provide one weight. 
