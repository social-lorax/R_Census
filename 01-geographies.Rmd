...
In NYC, PUMAs are an approximation of Community Districts, although the Census Bureau worked with NYC DCP to create new [Community District Tabulation Areas (CDTAs)](https://www.nyc.gov/site/planning/data-maps/open-data/census-download-metadata.page):

```{r echo = FALSE}
tibble(Tract = c(36005001901, 36005001902, 36005001903, 36005002300, 36005002500),
       Borough = "Bronx",
       `NTA Code` = "BX0101", 
       `NTA Name` = "Mott Haven-Port Morris",
       `CDTA Code` = "BX01",
       `CDTA Name` = "BX01 Melrose-Mott Haven-Port Morris (CD 1 Approximation)") %>% 
  datatable()
```
